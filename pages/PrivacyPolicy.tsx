    ...
    <div className="bg-white min-h-screen py-20 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-slate lg:prose-lg max-w-none text-slate-600 space-y-6">
          ...
          <p>Canada’s Home Renovation Depot ("we," "us," or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your personal information when you visit our website or use our HVAC services in the Greater Toronto Area.</p>
          ...
          <p>You have the right to access, correct, or request the deletion of your personal data. Please contact our Mississauga office at (416) 410-1744 for any privacy-related inquiries.</p>
        </div>
      </div>
    </div>
  );
