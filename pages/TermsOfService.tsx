    ...
    <div className="bg-white min-h-screen py-20 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-slate lg:prose-lg max-w-none text-slate-600 space-y-6">
          ...
          <p>While we strive for a 2-hour response time in Mississauga, dispatch times are subject to crew availability, weather conditions, and traffic. Our "Live Ops" dashboard provides estimates and does not guarantee exact arrival times.</p>
          ...
          <p>Canada’s Home Renovation Depot is not liable for indirect or consequential damages resulting from equipment failure or service delays. Our liability is limited to the value of the service contract performed.</p>
        </div>
      </div>
    </div>
  );
